...
var NTI16144 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NNI16144 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI140, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI104, name: "Field1", sons: null}]};
NTI16144.node = NNI16144;
...
function nimCopy(dest_18030, src_18031, ti_18032) {
	var result_18443 = null;

		switch (ti_18032.kind) {
		case 21:
		case 22:
		case 23:
		case 5:
			if (!(is_fat_pointer_18001(ti_18032))) {
			result_18443 = src_18031;
			}
			else {
				result_18443 = [src_18031[0], src_18031[1]];
			}
			
			break;
		case 19:
			      if (dest_18030 === null || dest_18030 === undefined) {
        dest_18030 = {};
      }
      else {
        for (var key in dest_18030) { delete dest_18030[key]; }
      }
      for (var key in src_18031) { dest_18030[key] = src_18031[key]; }
      result_18443 = dest_18030;
    
			break;
		case 18:
		case 17:
			if (!((ti_18032.base == null))) {
			result_18443 = nimCopy(dest_18030, src_18031, ti_18032.base);
			}
			else {
			if ((ti_18032.kind == 17)) {
			result_18443 = (dest_18030 === null || dest_18030 === undefined) ? {m_type: ti_18032} : dest_18030;
			}
			else {
				result_18443 = (dest_18030 === null || dest_18030 === undefined) ? {} : dest_18030;
			}
			}
			nimCopyAux(result_18443, src_18031, ti_18032.node);
			break;
		case 24:
		case 4:
		case 27:
        ...
        if (dest_18030 === null || dest_18030 === undefined) {
          dest_18030 = new Array(src_18031.length);
        }
        else {
          dest_18030.length = src_18031.length;
        }
        result_18443 = dest_18030;
        for (var i = 0; i < src_18031.length; ++i) {
          result_18443[i] = nimCopy(result_18443[i], src_18031[i], ti_18032.base);
        }
      }
		...
		case 28:
			      if (src_18031 !== null) {
        result_18443 = src_18031.slice(0);
      }
...
function makeNimstrLit(c_17024) {
		  var ln = c_17024.length;
  var result = new Array(ln);
  for (var i = 0; i < ln; ++i) {
    result[i] = c_17024.charCodeAt(i);
  }
  return result;
...
function arrayConstr(len_18504, value_18505, typ_18506) {
		    var result = new Array(len_18504);
    for (var i = 0; i < len_18504; ++i) result[i] = nimCopy(null, value_18505, typ_18506);
    return result;
...
function cstrToNimstr(c_17041) {
		  var ln = c_17041.length;
  var result = new Array(ln);
  var r = 0;
  for (var i = 0; i < ln; ++i) {
    var ch = c_17041.charCodeAt(i);
      ...
      if (ch < 2048) {
        ...
        if (ch < 55296 || ch >= 57344) {
          result[r] = (ch >> 12) | 224;
            ...
            ++i;
            ch = 65536 + (((ch & 1023) << 10) | (c_17041.charCodeAt(i) & 1023));
            result[r] = (ch >> 18) | 240;
            ++r;
...
function toJSStr(s_17058) {
		  if (s_17058 === null) return "";
  var len = s_17058.length;
  ...
  for (var i = 0; i < len; ++i) {
    if (nonAsciiPart !== null) {
      ...
      var code = s_17058[i].toString(16);
      if (code.length == 1) {
        code = "0"+code;
      }
      nonAsciiPart[offset] = "%";
    ...
    else if (s_17058[i] < 128)
      asciiPart[i] = fcc(s_17058[i]);
    else {
      asciiPart.length = i;
      nonAsciiOffset = i;
...
function raiseException(e_16618, ename_16619) {
		e_16618.name = ename_16619;
		if ((excHandler == 0)) {
		unhandledException(e_16618);
		}
		
		e_16618.trace = nimCopy(null, raw_write_stack_trace_16441(), NTI138);
		throw e_16618;
...
function chckIndx(i_18523, a_18524, b_18525) {
			var Tmp1;

	var result_18526 = 0;

	BeforeRet: do {
			if (!(a_18524 <= i_18523)) Tmp1 = false; else {				Tmp1 = (i_18523 <= b_18525);			}		if (Tmp1) {
		result_18526 = i_18523;
		break BeforeRet;
		}
		else {
		raiseIndexError();
...
function subInt(a_17421, b_17422) {
		    var result = a_17421 - b_17422;
    if (result > 2147483647 || result < -2147483648) raiseOverflow();
    return result;
...
function chckRange(i_18542, a_18543, b_18544) {
			var Tmp1;

	var result_18545 = 0;

	BeforeRet: do {
			if (!(a_18543 <= i_18542)) Tmp1 = false; else {				Tmp1 = (i_18542 <= b_18544);			}		if (Tmp1) {
		result_18545 = i_18542;
		break BeforeRet;
		}
		else {
		raiseRangeError();
...
function mulInt(a_17439, b_17440) {
		    var result = a_17439 * b_17440;
    if (result > 2147483647 || result < -2147483648) raiseOverflow();
    return result;
...
function nimMax(a_17758, b_17759) {
		var Tmp1;
...
function nimMin(a_17740, b_17741) {
		var Tmp1;
...
var global_raise_hook_14218 = [null];
var local_raise_hook_14223 = [null];
var out_of_mem_hook_14226 = [null];
  if (!Math.trunc) {
...
function is_fat_pointer_18001(ti_18003) {
	var result_18004 = false;

	BeforeRet: do {
		result_18004 = !((ConstSet1[ti_18003.base.kind] != undefined));
		break BeforeRet;
	} while (false);
...
function nimCopyAux(dest_18035, src_18036, n_18038) {
		switch (n_18038.kind) {
		case 0:
			break;
		case 1:
			      dest_18035[n_18038.offset] = nimCopy(dest_18035[n_18038.offset], src_18036[n_18038.offset], n_18038.typ);
		...
		case 2:
			L1: do {
				...
				colontmp__147620 = (n_18038.len - 1);
				var res_147622 = 0;
				L2: do {
						L3: while (true) {
						if (!(res_147622 <= colontmp__147620)) break L3;
							i_18424 = res_147622;
							nimCopyAux(dest_18035, src_18036, n_18038.sons[i_18424]);
							res_147622 += 1;
						}
				} while(false);
			} while(false);
		...
		case 3:
			      dest_18035[n_18038.offset] = nimCopy(dest_18035[n_18038.offset], src_18036[n_18038.offset], n_18038.typ);
      for (var i = 0; i < n_18038.sons.length; ++i) {
        nimCopyAux(dest_18035, src_18036, n_18038.sons[i][1]);
      }
...
function add_14238(x_14241, x_14241_Idx, y_14242) {
		      if (x_14241[x_14241_Idx] === null) { x_14241[x_14241_Idx] = []; }
      var off = x_14241[x_14241_Idx].length;
      x_14241[x_14241_Idx].length += y_14242.length;
      for (var i = 0; i < y_14242.length; ++i) {
        x_14241[x_14241_Idx][off+i] = y_14242.charCodeAt(i);
      }
...
function aux_write_stack_trace_16139(f_16141) {
					var Tmp3;

	var result_16142 = [null];

		var it_16150 = f_16141;
		var i_16152 = 0;
		var total_16154 = 0;
		var temp_frames_16161 = arrayConstr(64, {Field0: null, Field1: 0}, NTI16144);
		L1: do {
				L2: while (true) {
					if (!!((it_16150 == null))) Tmp3 = false; else {						Tmp3 = (i_16152 <= 63);					}				if (!Tmp3) break L2;
					temp_frames_16161[i_16152].Field0 = it_16150.procname;
					temp_frames_16161[i_16152].Field1 = it_16150.line;
					i_16152 += 1;
					total_16154 += 1;
					it_16150 = it_16150.prev;
				}
		} while(false);
		L4: do {
				L5: while (true) {
				if (!!((it_16150 == null))) break L5;
					total_16154 += 1;
					it_16150 = it_16150.prev;
				}
		} while(false);
		result_16142[0] = nimCopy(null, [], NTI138);
		if (!((total_16154 == i_16152))) {
		if (result_16142[0] != null) { result_16142[0] = (result_16142[0]).concat(makeNimstrLit("(")); } else { result_16142[0] = makeNimstrLit("("); };
		if (result_16142[0] != null) { result_16142[0] = (result_16142[0]).concat(cstrToNimstr(((total_16154 - i_16152))+"")); } else { result_16142[0] = cstrToNimstr(((total_16154 - i_16152))+"").slice(); };
		if (result_16142[0] != null) { result_16142[0] = (result_16142[0]).concat(makeNimstrLit(" calls omitted) ...\x0A")); } else { result_16142[0] = makeNimstrLit(" calls omitted) ...\x0A"); };
		}
		
		L6: do {
			var j_16424 = 0;
			var colontmp__147660 = 0;
			colontmp__147660 = (i_16152 - 1);
			var res_147666 = colontmp__147660;
			L7: do {
					L8: while (true) {
					if (!(0 <= res_147666)) break L8;
						j_16424 = res_147666;
						add_14238(result_16142, 0, temp_frames_16161[j_16424].Field0);
						if ((0 < temp_frames_16161[j_16424].Field1)) {
						if (result_16142[0] != null) { result_16142[0] = (result_16142[0]).concat(makeNimstrLit(", line: ")); } else { result_16142[0] = makeNimstrLit(", line: "); };
						if (result_16142[0] != null) { result_16142[0] = (result_16142[0]).concat(cstrToNimstr((temp_frames_16161[j_16424].Field1)+"")); } else { result_16142[0] = cstrToNimstr((temp_frames_16161[j_16424].Field1)+"").slice(); };
						}
						
						if (result_16142[0] != null) { result_16142[0] = (result_16142[0]).concat(makeNimstrLit("\x0A")); } else { result_16142[0] = makeNimstrLit("\x0A"); };
						res_147666 -= 1;
					}
			} while(false);
		} while(false);

	return result_16142[0];

}

function raw_write_stack_trace_16441() {
	var result_16443 = null;

		if (!((framePtr == null))) {
		result_16443 = nimCopy(null, (makeNimstrLit("Traceback (most recent call last)\x0A")).concat(aux_write_stack_trace_16139(framePtr)), NTI138);
		}
		else {
			result_16443 = nimCopy(null, makeNimstrLit("No stack traceback available\x0A"), NTI138);
		}
...
function unhandledException(e_16505) {
		var buf_16506 = [[]];
		if (!(((e_16505.message != null ? e_16505.message.length : 0) == 0))) {
		if (buf_16506[0] != null) { buf_16506[0] = (buf_16506[0]).concat(makeNimstrLit("Error: unhandled exception: ")); } else { buf_16506[0] = makeNimstrLit("Error: unhandled exception: "); };
		if (buf_16506[0] != null) { buf_16506[0] = (buf_16506[0]).concat(e_16505.message); } else { buf_16506[0] = e_16505.message.slice(); };
		}
		else {
		if (buf_16506[0] != null) { buf_16506[0] = (buf_16506[0]).concat(makeNimstrLit("Error: unhandled exception")); } else { buf_16506[0] = makeNimstrLit("Error: unhandled exception"); };
		}
		
		if (buf_16506[0] != null) { buf_16506[0] = (buf_16506[0]).concat(makeNimstrLit(" [")); } else { buf_16506[0] = makeNimstrLit(" ["); };
		add_14238(buf_16506, 0, e_16505.name);
		if (buf_16506[0] != null) { buf_16506[0] = (buf_16506[0]).concat(makeNimstrLit("]\x0A")); } else { buf_16506[0] = makeNimstrLit("]\x0A"); };
		if (buf_16506[0] != null) { buf_16506[0] = (buf_16506[0]).concat(raw_write_stack_trace_16441()); } else { buf_16506[0] = raw_write_stack_trace_16441().slice(); };
		var cbuf_16601 = toJSStr(buf_16506[0]);
		framePtr = null;
		  if (typeof(Error) !== "undefined") {
    throw new Error(cbuf_16601);
  }
  else {
    throw cbuf_16601;
  }
...
function raiseOverflow() {
		var e_16864 = null;
		e_16864 = {m_type: NTI4246, parent: null, name: null, message: null, trace: null, raise_id: 0, up: null};
		e_16864.message = nimCopy(null, makeNimstrLit("over- or underflow"), NTI138);
		e_16864.parent = null;
		raiseException(e_16864, "OverflowError");
...
function raiseIndexError() {
		var e_16954 = null;
		e_16954 = {m_type: NTI4258, parent: null, name: null, message: null, trace: null, raise_id: 0, up: null};
		e_16954.message = nimCopy(null, makeNimstrLit("index out of bounds"), NTI138);
		e_16954.parent = null;
		raiseException(e_16954, "IndexError");
...
function sys_fatal_21237(message_21243) {
	var F={procname:"sysFatal.sysFatal",prev:framePtr,filename:"../../lib/system.nim",line:0};
	framePtr = F;
		F.line = 2949;
		var e_21245 = null;
		F.line = 2950;
		e_21245 = {m_type: NTI4250, parent: null, name: null, message: null, trace: null, raise_id: 0, up: null};
		F.line = 2951;
		e_21245.message = nimCopy(null, message_21243, NTI138);
		F.line = 2952;
		raiseException(e_21245, "AssertionError");
	framePtr = F.prev;

	
}

function raise_assert_21232(msg_21234) {
	var F={procname:"system.raiseAssert",prev:framePtr,filename:"../../lib/system.nim",line:0};
	framePtr = F;
		F.line = 3905;
		sys_fatal_21237(msg_21234);
	framePtr = F.prev;

	
}

function failed_assert_impl_21280(msg_21282) {
	var F={procname:"system.failedAssertImpl",prev:framePtr,filename:"../../lib/system.nim",line:0};
	framePtr = F;
		F.line = 3912;
		raise_assert_21232(msg_21282);
	framePtr = F.prev;
							...
							L5: do {
								F.line = 3948;
									...
									if (!(i_147690 < l_147692)) break L6;
										...
										F.line = 3951;
										failed_assert_impl_21280(makeNimstrLit("/home/travis/build/nim-lang/Nim/lib/system.nim(3951, 11) `len(a) == L` seq modified while iterating over it"));
										}
...
function raiseRangeError() {
		var e_16924 = null;
		e_16924 = {m_type: NTI4262, parent: null, name: null, message: null, trace: null, raise_id: 0, up: null};
		e_16924.message = nimCopy(null, makeNimstrLit("value out of range"), NTI138);
		e_16924.parent = null;
		raiseException(e_16924, "RangeError");
